...
public class GsonActivity$$ViewBinder<T extends GsonActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131427486, "field 'mTvTitle'");
    target.mTvTitle = finder.castView(view, 2131427486, "field 'mTvTitle'");
    ...
    view = finder.findRequiredView(source, 2131427432, "field 'mBtGjsonTojavalist' and method 'onClick'");
    target.mBtGjsonTojavalist = finder.castView(view, 2131427432, "field 'mBtGjsonTojavalist'");
    ...
    view = finder.findRequiredView(source, 2131427433, "field 'mBtGjsonTojsonObject' and method 'onClick'");
    target.mBtGjsonTojsonObject = finder.castView(view, 2131427433, "field 'mBtGjsonTojsonObject'");
    ...
    view = finder.findRequiredView(source, 2131427434, "field 'mBtGjsonTojsonArray' and method 'onClick'");
    target.mBtGjsonTojsonArray = finder.castView(view, 2131427434, "field 'mBtGjsonTojsonArray'");
    unbinder.view2131427434 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onClick(p0);
